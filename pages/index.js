...
const questions = [
  ...
  "Do you tell yourself you can stop drinking any time you want to, even though you keep getting drunk when you do not mean to?",
...
export default function Home() {
  ...
  const meetingGuideUrl = "https://www.aa.org/meeting-guide-app";
  const phoneNumber = "tel:+12128703400";
          ...
          <div className="max-w-lg w-full bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="bg-blue-50 rounded-xl p-6 mb-6">
              <p className="text-gray-700 text-sm leading-relaxed">
                Only you can decide whether you want to give AA a try and whether you think it can help you. 
